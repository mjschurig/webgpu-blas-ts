 ...
 * This is a WebGPU implementation of the reference BLAS SASUM function.
 */
...
/**
 * Compute the sum of absolute values of a vector using WebGPU (single precision)
 */
export async function sasum(params: SASUMParams): Promise<number> {
