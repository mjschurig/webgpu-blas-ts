/**
 * SCOPY - Copy vector x to vector y (single precision)
 * 
 * Performs the operation y := x where x and y are vectors.
 * This is a WebGPU implementation of the reference BLAS SCOPY function.
 */

/// <reference types="@webgpu/types" />

import { getWebGPUContext } from '../../webgpu/context';
import scopyShader from '../../shaders/scopy.wgsl';

/**
 * SCOPY parameters
 */
export interface SCOPYParams {
...
/**
 * Copy vector x to vector y using WebGPU (single precision)
 * Modifies the y vector in-place.
 */
export async function scopy(params: SCOPYParams): Promise<void> {
