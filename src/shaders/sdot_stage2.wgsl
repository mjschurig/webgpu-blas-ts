/**
 * SDOT Stage 2 Shader - Final reduction across workgroup results for dot product
 * 
 * Combines the partial dot products from all workgroups into a single final result.
 * This stage runs only when multiple workgroups were used in stage 1.
 * This is the WebGPU implementation of the second stage of BLAS SDOT operation.
 */
